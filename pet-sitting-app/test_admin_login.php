...
echo "\n=== Admin Panel URLs ===\n";
echo "Login: http://0.0.0.0:8000/admin/login\n";
echo "Email: admin@petsitconnect.com\n";
echo "Password: admin123\n";
echo "Verifications: http://0.0.0.0:8000/admin/verifications\n";
echo "Verification 105: http://0.0.0.0:8000/admin/verifications/105\n";
echo "Enhanced View: http://0.0.0.0:8000/admin/verifications/105/enhanced\n";
