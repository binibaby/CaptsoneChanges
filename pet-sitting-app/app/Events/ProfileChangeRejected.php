...
class ProfileChangeRejected implements ShouldBroadcast
{
    ...
    public function broadcastWith(): array
    {
        return [
            ...
            'message' => "Your profile change request for {$this->profileChangeRequest->getFieldDisplayName()} has been rejected. Reason: {$this->profileChangeRequest->admin_notes}"
        ];
    }
}