...
echo "1. Visit: http://192.168.100.204:8000/admin/verifications/104 (should show images and location)\n";
echo "2. Visit: http://192.168.100.204:8000/admin/verifications/78 (should show 'No Documents' message)\n";
?>
